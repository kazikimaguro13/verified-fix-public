// Port of ccd/guard_pathmatch.py — the verified-fix JS testbed subject.
// F (the defect): the directory-prefix match degrades to a bare string prefix,
// so allowlist entry "ccd" wrongly grants the sibling "ccd_evil/x.js".
...
// ---- THE ANCHOR FUNCTION (F の file:function — frozen before the fix) ----
